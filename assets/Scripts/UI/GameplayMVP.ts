...
export class GameplayMVP extends Component {
    ...
    protected onLoad():void {
        ...
        this.generator=new QuestionGenerator(new SeededRng(`${AppRuntime.entry.seed}:gameplay`),GAMEPLAY_CONFIG);this.director=new Brawl60Director(new SeededRng(`${AppRuntime.entry.seed}:director`),AppRuntime.entry.recipeId);this.visual=new SeededRng(`${AppRuntime.entry.seed}:visual`);
