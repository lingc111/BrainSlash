...
export type QuestionTemplateId =
    ...
    | 'hanzi-radical' | 'hanzi-homophone' | 'hanzi-compose' | 'hanzi-xiehouyu'
    | 'english-meaning' | 'english-category' | 'english-antonym' | 'english-length'
    | 'english-missing-letter' | 'english-synonym' | 'english-word-order'
    | 'life-category' | 'life-use' | 'life-place' | 'life-public-sign' | 'life-safe-behavior'
    ...
    | 'knowledge-astronomy' | 'knowledge-biology' | 'knowledge-physics'
    | 'history-modern-opening' | 'history-modern-awakening' | 'history-modern-resistance'
    | 'history-ancient' | 'history-myth' | 'history-myth-person' | 'history-chronology'
    | 'history-person-event' | 'history-allusion-person';
...
export const QUESTION_TEMPLATES: readonly QuestionTemplate[] = [
    ...
    define('math-property', 'math', 'condition', ['single', 'multi', 'master-slash', 'numeric'], 'algorithmic', ['arithmetic', 'property'], MULTI_RULES, 5),
    define('math-compare', 'math', 'compare', ['single', 'numeric'], 'algorithmic', ['compare'], CHOICE_RULES, 5),
    ...
    define('math-digit-reverse', 'math', 'single', ['single', 'numeric'], 'algorithmic', ['arithmetic', 'digit-reverse']),
    define('math-remainder', 'math', 'single', ['single', 'numeric'], 'algorithmic', ['arithmetic', 'remainder']),
    define('math-fraction-compare', 'math', 'compare', ['single', 'numeric'], 'algorithmic', ['arithmetic', 'fraction', 'compare']),
    ...
    define('hanzi-xiehouyu', 'hanzi', 'pair', ['single', 'short-text'], 'reviewed-facts', ['xiehouyu']),
    ...
    define('history-myth-person', 'history', 'pair', ['single', 'short-text'], 'reviewed-facts', ['myth', 'person-event']),
    ...
    define('history-allusion-person', 'history', 'pair', ['single', 'short-text'], 'reviewed-facts', ['allusion', 'person-event']),
];
