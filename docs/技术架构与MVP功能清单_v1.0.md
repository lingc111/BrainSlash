...
玩家进入首页后，可以一键开始 60 秒乱斗；在 2–6 个运动目标中，根据当前提示和规则连续划动斩击；系统实时处理正确、错误、Combo、生命、Master Hit 与难度变化；结算后可以立即重开，或把同一局面的挑战分享给好友。
...
| 40–60 秒 | 4–6 | 最多叠加 2 个复杂规则 | 提速但不改变判定公平性 |
